...
if [[ -z "${V_ADMIN_PASSWORD}" ]]; then
  echo "Enter a password for stackmattic's dashboard:"
...
server {
    ...
    listen [::]:80;
    server_name _;
    root /home/${V_USERNAME}/stackmattic/public;
...
"
rm -rf /home/${V_USERNAME}/stackmattic
mkdir /home/${V_USERNAME}/stackmattic
chown -R ${V_USERNAME}:${V_USERNAME} /home/${V_USERNAME}/stackmattic
chmod -R 755 /home/${V_USERNAME}/stackmattic
rm /etc/nginx/sites-available/default
rm /etc/nginx/sites-enabled/default
echo "${V_VHOST_CONFIG}" | tee /etc/nginx/sites-available/stackmattic
ln -s /etc/nginx/sites-available/stackmattic /etc/nginx/sites-enabled/
service nginx restart
rm -rf /home/${V_USERNAME}/stackmattic
git config --global core.fileMode false
git clone -b ${stackmattic_VERSION} ${V_REPO} /home/${V_USERNAME}/stackmattic
find /home/${V_USERNAME}/stackmattic -type d -exec chmod 755 {} \;
find /home/${V_USERNAME}/stackmattic -type f -exec chmod 644 {} \;
cd /home/${V_USERNAME}/stackmattic && git config core.fileMode false
cd /home/${V_USERNAME}/stackmattic
git checkout $(git tag -l --merged ${VITO_VERSION} --sort=-v:refname | head -n 1)
composer install --no-dev
cp .env.prod .env
touch /home/${V_USERNAME}/stackmattic/storage/database.sqlite
php artisan key:generate
php artisan storage:link
php artisan migrate --force
php artisan user:create stackmattic ${V_ADMIN_EMAIL} ${V_ADMIN_PASSWORD}
openssl genpkey -algorithm RSA -out /home/${V_USERNAME}/stackmattic/storage/ssh-private.pem
chmod 600 /home/${V_USERNAME}/stackmattic/storage/ssh-private.pem
ssh-keygen -y -f /home/${V_USERNAME}/stackmattic/storage/ssh-private.pem > /home/${V_USERNAME}/stackmattic/storage/ssh-public.key
chown -R ${V_USERNAME}:${V_USERNAME} /home/${V_USERNAME}/stackmattic/storage/ssh-private.pem
chown -R ${V_USERNAME}:${V_USERNAME} /home/${V_USERNAME}/stackmattic/storage/ssh-public.key

# setup supervisor
export V_WORKER_CONFIG="
[program:worker]
process_name=%(program_name)s_%(process_num)02d
command=php /home/${V_USERNAME}/stackmattic/artisan queue:work --sleep=3 --backoff=0 --queue=default,ssh,ssh-long --timeout=3600 --tries=1
autostart=1
autorestart=1
user=stackmattic
...
# setup cronjobs
echo "* * * * * cd /home/${V_USERNAME}/stackmattic && php artisan schedule:run >> /dev/null 2>&1" | sudo -u ${V_USERNAME} crontab -
